...
--
-- Host: localhost
-- Generation Time: Jan 13, 2026 at 04:57 AM
...
--
ALTER TABLE `dailyaccompinformation`
  MODIFY `dailyaccompid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3569;
...
--
ALTER TABLE `employeeofficeinformation`
  MODIFY `employeeofficeid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=479;
...
--
ALTER TABLE `sectioninformation`
  MODIFY `sectionid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `taskoutputinformation`
--
ALTER TABLE `taskoutputinformation`
  MODIFY `taskoutputid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5714;

--
-- AUTO_INCREMENT for table `timerecordinformation`
--
ALTER TABLE `timerecordinformation`
  MODIFY `timerecordid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29158;
...
--
ALTER TABLE `userlogs`
  MODIFY `userlogId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64969;
COMMIT;
